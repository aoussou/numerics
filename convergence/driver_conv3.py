...
l4, = plt.loglog(DT[sp1-1:ep],cl[sp1-1:ep],'-.k',label='2nd order')
...
plt.title("time converge \n 3rd order upwind space discretization",fontsize=fsst)    

plt.legend(handles=[l1,l2,l3,l4],fontsize = fsg)
plt.tick_params(axis='both', which='major', labelsize=40)

fig2.savefig('conv3.png', bbox_inches='tight',dpi=400)